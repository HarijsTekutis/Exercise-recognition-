...
def train_xgboost(
	...
	patience: int = 7,
	best_model_path: str = "xgboost.pt",
) -> Dict[str, List[float]]:
	del device, learning_rate, num_epochs, clip_grad_norm, patience  # Not used by XGBoost
