...
if __name__ == "__main__":
    ...
    study = optuna.create_study(direction="maximize", study_name="optimize_MultiHeadCNNResBiLSTM_subject_independent", storage=db_path, load_if_exists=True)
    ...
    val_result = evaluate_multi_head_cnn_resbilstm(
        model=model,
        data_loader=splits.val_loader,
        device=device,
        history=history,
    ...
    test_result = evaluate_multi_head_cnn_resbilstm(
        model=model,
